...
**
        ***__General orders__***
**
!id [اضهار ملومات عن حسابك]
!draw [يكرر كلامك في صوره]
!embed [يكرر كلامك في صورة ]
!roles [يعرض لك الرتب الموجوده في السيرفر]
!rooms [يرض لك الروامت الموجوده في السيرفر وعددها]
!server [يغرض لك معلومات عن السيرفر]
!animal [يعرض لك صور حساوانات]
!image [يعرض لك صورة السيرفر]
!avatar [يعرض لك الافتار الخاصة بك]
...
**
        ***__Special orders __***
**
f!colors / لي عرض قائمه الوان السيرفر』
f!color / لي تغير لونك』
**
        ***__Games orders__***
 **       
!لعبه صراحه / صراحه』
